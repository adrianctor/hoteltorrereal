    ...
    <section class="content">
      ...
      <div class="card" style="margin-top: 7px;">
        <div class="card-header">
          <button class="btn btn-primary" data-toggle="modal" data-target="#mdlAgregarCliente"> Agregar proveedor</button>
        </div>
        <div class="card-body">
  ...
  <div id="mdlAgregarCliente" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="box-body">
              ...
              <div class="row">
                ...
                <div class="col">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <select class="form-control input-lg selectDepartamento nuevoDepartamento" id="nuevoDepartamento" name="nuevoDepartamento">
                      </select>
                ...
                <div class="col">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <select class="form-control input-lg selectCiudad nuevoCiudad" id="nuevoCiudad" name="nuevaCiudad" >
                      </select>
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <input type="text" class="form-control input-lg" id="nuevaDir" name="nuevaDireccion" placeholder="Ingresar la dirección *" autocomplete="off" onkeyup="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    <div class="input-group">
                      <input style="margin-left: 4px;" type="tel" class="form-control input-lg" name="nuevoTelefono" placeholder="Ingresar el número de telefono *" data-mask autocomplete="off">
      ...
      <?php
      $crearCliente = new ControladorDistribuidor();
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <form role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              ...
              <div class="row">
                ...
                <div class="col">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <select class="form-control input-lg selectEditarCiudad editarCiudad" id="editarCiudad" name="editarCiudad">
                      </select>
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <input type="text" class="form-control input-lg" id="editarDir" name="editarDireccion" placeholder="Ingresar la dirección *" autocomplete="off" onkeyup="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()">
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    <div class="input-group">
                      <input style="margin-left: 4px;" type="tel" class="form-control input-lg" id="editarTelefono" name="editarTelefono" placeholder="Ingresar el número de telefono *" data-mask autocomplete="off">
          ...
          <?php
          $editarCliente = new ControladorDistribuidor();
  ...
  <?php
  $borrarCliente = new ControladorDistribuidor();
  $borrarCliente->ctrBorrarProveedor();
  ?>