...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function renderInnerContent$1$1(innerProps) {
        ...
        return (y("div", { className: "fc-event-main-frame" },
        innerProps.timeText && (y("div", { className: "fc-event-time" }, "")),
        y("div", { className: "fc-event-title-container" },
            y("div", { className: "fc-event-title fc-sticky" }, innerProps.event.title || y(_, null, "\u00A0")))));
    }
    ...
    */
    ...
    class TimelineHeaderTh extends BaseComponent {
        ...
        render() {
            ...
            if(cell.text.includes("L") && !cell.text.includes("Lun")){
                cell.text = cell.text.replace("L","Lun");
            }
            else if(cell.text.includes("M") && !cell.text.includes("Mar")&&!cell.text.includes("Mié")){
                cell.text = cell.text.replace("M","Mar");
            }
            else if(cell.text.includes("X") && !cell.text.includes("Mié")){
                cell.text = cell.text.replace("X","Mié");
            }
            else if(cell.text.includes("J") && !cell.text.includes("Jue")){
                cell.text = cell.text.replace("J","Jue");
            }
            else if(cell.text.includes("V") && !cell.text.includes("Vie")){
                cell.text = cell.text.replace("V","Vie");
            }
            else if(cell.text.includes("S") && !cell.text.includes("Sáb")){
                cell.text = cell.text.replace("S","Sáb");
            }
            else if(cell.text.includes("D") && !cell.text.includes("Dom")){
                cell.text = cell.text.replace("D","Dom");
            }
            let renderProps = this.refineRenderProps({
