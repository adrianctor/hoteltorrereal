        ...
        public function ajaxGetReservas(){
            ...
            foreach ($respuesta as $reserva){
                ...
                $varDatosJSON .= '{ "id": "'.
                                ...
                                '", "resourceId": "'.
                                $reserva['habId'].
                                // '", "start":"'.date_format($dateini,"Y-m-d\TH:i:s").
                                '", "start":"'.date_format($dateini,"Y-m-d\T").'00:00:00'.
                                // '", "start":"'.'2025-01-26T23:59:59'.
                                // '","end":"'.date_format($datefin,"Y-m-d\TH:i:s").
                                '","end":"'.date_format($datefin,"Y-m-d\T").'11:59:00'.
                ...
                // $varDatosJSON .='","endDate":"'.'2025-01-26T18:59:59';
